...
void joystick_init(void) {
  ...
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3<<20); //PIN mode GPIO (00b value per P1.20)
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1<<26); //P1.26 Input (joysticks on PORT1 defined as Input)


  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3<<22); //PIN mode GPIO (00b value per P1.22)
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1<<27); //P1.27 Input (joysticks on PORT1 defined as Input)


  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3<<24); //PIN mode GPIO (00b value per P1.24)
