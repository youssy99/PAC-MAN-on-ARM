...
uint32_t init_timer ( uint8_t timer_num, uint32_t TimerInterval )
{
 ...
 //((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR1 = TimerInterval/2;
...
// </e>
 ...
 //((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR |= 1<<3;
// </h>
// <<< end of configuration section >>>
 ...
 __NVIC_SetPriority(TIMER1_IRQn, 5);
 return (1);
  }else if( timer_num == 2)
 {
